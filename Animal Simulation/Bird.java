...
public class Bird extends Prey {
     ...
     */    
    public Bird(boolean randomAge, Field field, Location location,Simulator sim){
    ...
    protected void giveBirth(List<Animal> newPreys)
    {
        ...
        for(int b = 0; b < births && free.size() > 0; b++) {
            Location loc = free.remove(0);
                Prey young = new Bird(false, field, loc, getSimulator());
                newPreys.add(young);
        }
    }
     ...
     * @return true if the bird can breed, false otherwise.
     */
